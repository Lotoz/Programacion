...
public class VehiculosApp {
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.printf("=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=%n");
//CORREGIR COLOR Y MOTO 
  
     // Le pedimos al usario que introduzca la matricula del automovil 
    System.out.printf("Introduce la matrícula del automóvil (4 números, 0 ó más espacios\n"
  ...
  // Pedimos el año de la fecha de matriculacion 
     ...
     // Pedimos el color 
     System.out.printf("Introdu111zca el color del automóvil (blanco, negro o azul):%n");
     ...
     Fecha fechaAuto = new Fecha( dia1, mes1, anyo1);
     Automovil auto = new Automovil(matricula1,fechaAuto, color, plazas);
     
     
       // Pedimos la matricula de la moto 
     System.out.printf("Introduce la matrícula del motocicleta (4 números, 0 ó más espacios "
       + "y tres letras mayúsculas):%n"); 
     String matricula2 = scan.next();
       ...
       Fecha fechaMoto = new Fecha(dia2, mes2, anyo2);
       Motocicleta moto = new Motocicleta(matricula2, fechaMoto, cilindrada);
   ...
   System.out.printf("El automóvil lleva matriculado %d %n", fechaAuto.diasTranscurridos());
   System.out.printf("El motocicleta lleva matriculado %d %n", fechaMoto.diasTranscurridos());
