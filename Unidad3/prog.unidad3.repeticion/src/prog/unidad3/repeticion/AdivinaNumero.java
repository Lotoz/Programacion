...
public class AdivinaNumero {
  ...
  public static void main(String[] args) {
    ...
    do {
      ...
      System.out.printf("He pensado un número entre %d y %d. Intenta adivinarlo%n", LIMITE_INFERIOR, LIMITE_SUPERIOR);

      // Hasta que no se agoten los intentos o se encuentre el número (lo que pase
      // antes)
      do {
        ...
        do {
          ...
          System.out.printf("Intento %d. Introduce un número entre %d y %d: ", intento, LIMITE_INFERIOR,
              LIMITE_SUPERIOR);
          numero = Integer.parseInt(sc.nextLine());

          // Si el número no es válido muestra un mensaje
          if (numero < LIMITE_INFERIOR || numero > LIMITE_SUPERIOR) {
            System.out.printf("El número %d no está en el rango %d-%d. Inténtalo de nuevo%n", numero, LIMITE_INFERIOR,
                LIMITE_SUPERIOR);
          }
        ...
        if (numero == objetivo) {
          ...
          System.out.printf("Has acertado en %d intento%s. El número era %d%n", intento, (intento > 1) ? "s" : "",
              objetivo);
          ...
          System.out.printf("El número es %s que %d%n", (numero > objetivo) ? "menor" : "mayor", numero);
