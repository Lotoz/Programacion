...
public interface ProveedorAlmacenamientoEmpresa {
	...
	//METODOS DEPARTAMENTOS ARRANCAN AQUI

	/**
	 * Obtiene todos los departamentos almacenados
	 * 
	 * @param ordenarPorNombre true si los departamentos se deben devolver ordenados
	 *                         por nombre, false si no es necesario
	 ...
	 * @return Departamento con el código especificado o null si no existe un
	 *         departamento con el código especificado
	 * @throws ProveedorAlmacenamientoEmpresaException Si ocurrió algún error
	 *                                                 accediendo al almacenamiento
	 */
	 ...
	 * 
	 * @param departamento Departamento a añadir. El código del departamento se
	 *                     ignora y se genera uno automáticamente.
	 * @return Departamento almacenado. Todos los datos serán iguales a los del
	 *         departamento de entrada pero el código será el que ha generado el
	 *         sistema automáticamente. El mismo si no se pudo realizar la inserción
	 ...
	 * 
	 * @param departamento Departamento a actualizar. Debe existir previamente un
	 *                     departamento con el mismo código en el almacenamiento. No
	 *                     puede ser null
	 * @throws NullPointerException                    Si departamento es null
	 * @throws ProveedorAlmacenamientoEmpresaException Si ocurrió algún error
	 *                                                 accediendo al almacenamiento
	 *                                                 o no existe un departamento
	 *                                                 en el almacenamiento con el
	 ...
	 * @return Empleado con el código especificado o null si no existe un empleado
