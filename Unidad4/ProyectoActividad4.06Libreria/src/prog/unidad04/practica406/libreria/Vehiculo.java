...
public class Vehiculo {
  ...
  protected Vehiculo(String matricula, Fecha fechaMatriculacion) {
    if (validadorMatricula(matricula)) {
      ...
      throw new IllegalArgumentException(
          "La matricula introducida es incorrecta. Revise los valores e intentelo de nuevo.");
    }
   ...
   * Valida la matricula
   * 
   * @param matricula Matrícula del vehiculo. Debe tener un formato válido NNNN
   *                  AAA donde NNNN son 4 dígitos y AAA son tres letras
   *                  MAYÚSCULAS. Entre ellas puede haber cuantos espacios se
   *                  quiera (incluido ninguno).
  ...
  /**
   * Obtiene la representación en texto del vehiculo en formato: Matricula:
   * matricula, Fecha Matriculación: dd de mmmmm de aaaa.
   */
