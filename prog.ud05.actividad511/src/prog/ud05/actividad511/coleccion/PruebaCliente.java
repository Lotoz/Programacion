...
class PruebaCliente {
  ...
  //Mis junit
  @Test
  void testClienteDniInvalido() {
      // Caso: Crea un cliente con un DNI inválido
      String nombre = "Juan Antonio";
      String apellidos = "Aitor Tilla";
      String dni = "29301068Z"; // DNI inválido
      int edad = 25;

      // Debe lanzar IllegalArgumentException al crearse
      assertThrows(IllegalArgumentException.class, () -> {
          new Cliente(nombre, apellidos, dni, edad);
      });
  }

  @Test
  void testClienteDniFormatoIncorrecto() {
      // Caso: Crea un cliente con un DNI en formato incorrecto
      String nombre = "Juan Antonio";
      String apellidos = "Aitor Tilla";
      String dni = "2930106B"; // Formato incorrecto (7 dígitos y 1 letra)
      int edad = 25;
